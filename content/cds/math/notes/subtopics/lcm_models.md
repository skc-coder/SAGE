...
$$\text{Least } N = \operatorname{LCM}(x, y, z) - p \quad \text{where } p = (x-a) = (y-b) = (z-c)$$

---

### Model 3: Divisibility Condition on Remainder Model ($N \pmod M \equiv 0$)
$$N = k \cdot \operatorname{LCM}(x, y, z) + R \quad \text{solve } k \text{ for } N \equiv 0 \pmod M$$
...
- [[cds/math/notes/questions/q7|Question 7: LCM Constant Difference]]
...
- [[cds/math/notes/variations/var10|Variation 10: Largest 4-Digit Number with Constant Remainder]]
- [[cds/math/notes/variations/var11|Variation 11: Smallest 4-Digit Number with Constant Difference]]
