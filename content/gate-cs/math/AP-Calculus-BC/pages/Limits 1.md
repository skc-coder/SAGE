...
![](padai%20(copy%201)/maths/Calculus/AP-Calculus-BC/pages/attachments/Pasted%20image%2020260614154802.png)

Step 2:
divide out: put the limit approach value an d see if both num and deno become 0 if so then the have common factor cancel them out
![](padai%20(copy%201)/maths/Calculus/AP-Calculus-BC/pages/attachments/Pasted%20image%2020260614154920.png)

anohter method Rationalizing Technique