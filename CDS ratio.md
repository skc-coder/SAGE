![[Pasted image 20260912083114.png]]
...
**Step 2: Find individual values of $a$, $b$, and $c$**

Subtract each given pair from the total sum ($9$):
...
- **Numerator:** $a - b + c = 2 - 3 + 4 = 3$
    
- **Denominator:** $a + b - c = 2 + 3 - 4 = 1$
    

$$\frac{a - b + c}{a + b - c} = \frac{3}{1}$$
