...
- Do NOT output update file blocks mid-conversation. Accumulate all changes and output one single block only when user explicitly says "give me the update file".
